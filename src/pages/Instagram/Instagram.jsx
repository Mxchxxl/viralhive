...
const Instagram = () =>
{
  ...
  const heroContent = {
    smallHeading: "Instagram Influencer Marketing Simplified",
    bigHeading: "Unlike any Instagram influencer marketing agency.",
    text: (
      <>
        <p>Somewhere along the way, people forgot about  <span className="text-violet">quality Instagram influencer marketing.</span> </p>
  ...
  const ServiceDescriptionContent = {
    mainDescriptionHeading: "Instagram",
    mainDescriptionText: <>
    ...
    serviceSteps: [
      {
        text: "Building a testing roadmap for your Instagram campaign",

        img: "/images/purple_Group.svg",
        reverse: false
      },
      {
        text: "Choosing the best-fit Instagram Influencers to work with.",
      ...
      {
        text: "Executing the entire Instagram campaign from start to finish, including quality control.",
      ...
      {
        text: "Optimizing and building upon your success to develop a long-term strategy for your Instagram influencer marketing channel.",
    ...
    servicePromos: [
      {
        ...
        smallText: "Most influencer agencies price their creators based on average views and follower counts. We focus on median views and historical performance which leads to better relationships with our creators and better CPM for brand partners like you."
      },
      {
      ...
      },
      {
        ...
        smallText: "We know the difference between riding the bandwagon and driving it. We like to observe the trends of instagram and employ strategies that leverage trends without diluting content quality."
      }
    ]
  }
